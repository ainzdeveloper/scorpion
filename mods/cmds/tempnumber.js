...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Ainz",
  description: "this command will help you to generate an temporary mobile number from another country or random country!",
  usage: "{pref}[name of cmd] [generate/inbox] [mobile-number] [1-10]",
  usePrefix: true,
  commandCategory: "Fun",
  cooldowns: 0
};  
